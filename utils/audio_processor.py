...
def download_youtube_audio(url :str) ->str:
    ...
    ydl_opts = {
        ...
        "js_runtimes": {"node": {}},
        "overwrites": True,  # <--- Tells yt-dlp to safely overwrite existing files
        "postprocessors": [
            {
...
def convert_to_wav(input_path: str) -> str:
    ...
    output_path = os.path.splitext(input_path)[0] + "_converted.wav"    # Define the output path with a new filename
    audio = AudioSegment.from_file(input_path)    # Load the audio/video file
