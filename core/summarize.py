    ...
    combine_prompt = ChatPromptTemplate.from_messages(
        [
            (
                ...
                "Please combine the following summaries into a single summary.",
            ),
            ("human", "{text}"),
        ]
    )
...
def generate_title(transcript: str) -> str:
    ...
    return title_chain.invoke(transcript[:2000]) # Limit to first 2000 characters for title generation
